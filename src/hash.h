#ifndef ULISK_HASH_H_
#define ULISK_HASH_H_
/*
...
// inline size_t h3(const void *key, size_t len, size_t seed = 0xc70697UL) {
//   return hash_funcs[2](key, len, seed);
// }

// inline size_t h4(const void *key, size_t len, size_t seed = 0xc70697UL) {
